...
module.exports = {
  ...
  afterConstruct: function(self) {
    ...
    if (self.options.baseUrl && (!self.geop.baseUrl)) {
      self.geop.utils.error('WARNING: you have baseUrl set as an option to the `apostrophe-express` module.');
      self.geop.utils.error('Set it as a global option (a property of the main object passed to apostrophe).');
  ...
  construct: function(self, options) {
    ...
    // Create Apostrophe's `geop.app` and `geop.express` objects
    ...
    self.sessions = function() {
      ...
      if (sessionOptions.secret === 'you should have a secret') {
        self.geop.utils.error('WARNING: No session secret provided, please set the `secret` property of the `session` property of the apostrophe-express module in app.js');
      }
    ...
    // Establish the `geop.listen` method, which Apostrophe will invoke
