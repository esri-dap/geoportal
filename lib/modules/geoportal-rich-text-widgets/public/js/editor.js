geop.define('geoportal-rich-text-widgets-editor', {
  ...
  construct: function(self, options) {
    ...
    self.start = function() {
      ...
      self.config = {
        ...
        on: {
          ...
          // really belongs to geoportal and play nice if not
          ...
          instanceReady: function(ck) {
            ck.editor.geopWidgetEditor = self;
          }
        }
      };
    ...
    // `geop-active` CSS class. Reflects what has already happened
    ...
    self.setActive = function(state) {
      ...
      return self.$widget.toggleClass('geop-active', state);
    };
