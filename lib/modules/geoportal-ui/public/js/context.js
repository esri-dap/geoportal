  ...
  construct: function(self, options) {
    ...
    self.link = function(verb, object, fn) {
      ...
      if (self.$controls && (!(self.$el.find(self.$controls).length))) {
        geop.ui.link(self.$controls, verb, object, fn);
      }

      geop.ui.link(self.$el, verb, object, fn);

    };

    // Invoke a JSON API route implemented by the Geoportal module
    ...
    // Invoke an API route implemented by the Geoportal module
    // associated with this object, or by another module if the
    // ":" syntax is used, like: `module-name:verb`
    //
