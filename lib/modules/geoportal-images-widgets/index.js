...
//
// See [adding editable content to pages](https://docs.geoportalcms.org/geoportal/tutorials/getting-started/adding-editable-content-to-pages#geoportal-images) for a thorough discussion of the options that can be passed to the widget.
