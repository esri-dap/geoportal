...
geop.define('geoportal-users-editor-modal', {

  extend: 'geoportal-pieces-editor-modal',
  ...
  construct: function(self, options) {
    ...
    self.enableTitleViaName = function() {
      self.$title = geop.schemas.findField(self.$el, 'title');
      self.$firstName = geop.schemas.findField(self.$el, 'firstName');
      self.$lastName = geop.schemas.findField(self.$el, 'lastName');
    ...
    self.enableUsernameViaTitle = function() {
      self.$username = geop.schemas.findField(self.$el, 'username');
    ...
    self.updateUsernameViaTitle = function() {
      ...
      var username = geop.utils.slugify(self.$title.val());
