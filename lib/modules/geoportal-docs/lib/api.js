...
module.exports = function(self, options) {
  ...
  self.ensureIndexes = function(callback) {
    ...
    function indexText(callback) {
      return self.ensureTextIndex(function(err) {
        if (err) {
          self.geop.utils.error('WARNING: unable to ensure text index, apostrophe:migrate can fix that');
        }
  ...
  self.find = function(req, criteria, projection) {
    ...
    return self.geop.create('geoportal-cursor', { apos: self.apos, req: req, criteria: criteria, projection: projection });
  };
