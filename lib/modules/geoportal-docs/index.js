// This module is responsible for managing all of the documents (geoportal "docs")
...
// is `geop.docs.find()`, which returns a [cursor](https://docs.geoportalcms.org/geoportal/modules/geoportal-docs/server-geoportal-cursor) for
// fetching documents of all types. This is useful when implementing something
// like the [geoportal-search](https://docs.geoportalcms.org/geoportal/modules/geoportal-search) module.
//
// ## Options
//
...
// moving pages from trashing pages, which is useful for the `geoportal-workflow`
...
//
// **`conflictResolution`: by default, Geoportal will attempt to resolve
...
//
// **`deconflictSlugs`: by default, Geoportal will suggest nonconflicting
...
//
// ** `advisoryLockTimeout`: Geoportal locks documents while they are
...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.geop.define('geoportal-cursor', require('./lib/cursor.js'));
