geop.define('geoportal-attachments-focal-point-editor', {
  ...
  construct: function(self, options) {
    ...
    self.afterShow = function() {
      ...
      self.$focalPointImage.attr('src', geop.attachments.url(self.attachment, { size: 'original', crop: options.crop }));
