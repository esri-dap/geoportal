geop.define('geoportal-doc-type-manager-relationship-editor', {
  ...
  construct: function(self, options) {
    ...
    self.beforeShow = function(callback) {
      ...
      return geop.schemas.populate(self.$form, self.nonInlineSchema, self.choice, callback);
    };
    self.saveContent = function(callback) {
      return geop.schemas.convert(self.$form, self.nonInlineSchema, self.choice, {}, function(err) {
        if (err) {
          return callback(err);
        }
