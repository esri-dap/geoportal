// This module is the base class of `geoportal-custom-pages`, `geoportal-pieces`,
// `geoportal-global` and any other module that serves as the manager for a
...
// See the [schema guide](https://docs.geoportalcms.org/geoportal/tutorials/getting-started/schema-guide).
...
module.exports = {
  ...
  afterConstruct: function(self) {
    ...
    self.defineCursor();
    self.composeSchema();
    self.geop.docs.setManager(self.name, self);
    self.pushAssets();
  ...
  beforeConstruct: function(self, options) {
    ...
    options.addFields = [
      ...
      },
      {
        ...
        contextual: !options.geop.docs.trashInSchema,
        def: false
      }
    ...
    options.arrangeFields = [
      {
        name: 'basics',
        label: 'Basics',
        fields: [ 'title', 'slug', 'published', 'tags' ].concat(options.geop.docs.trashInSchema ? [ 'trash' ] : [])
      },
      {
        name: 'permissions',
        label: 'Permissions',
        fields: options.geop.schemas.getPermissionsFieldNames(),
        last: true
      }
    ].concat(options.arrangeFields || []);
    if (options.geop.docs.trashInSchema) {
  ...
  construct: function(self, options) {
    ...
    if (!options.name) {
      throw new Error('geoportal-doc-type-manager requires name option in module ' + self.__meta.name);
    }
