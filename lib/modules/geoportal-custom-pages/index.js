...
//
// The [geoportal-pieces-pages](https://docs.geoportalcms.org/geoportal/modules/geoportal-pieces-pages) module
...
// Geoportal's schemas and modals, that are normally reserved for logged-in users
  ...
  beforeConstruct: function(self, options) {
    ...
    options.addFields = [
      ...
      },
      {
        ...
        label: 'Type',
        required: true,
        choices: _.map(options.geop.pages.typeChoices, function(type) {
          return {
            value: type.name,
            label: type.label
          };
