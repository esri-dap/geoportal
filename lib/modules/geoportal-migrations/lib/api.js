...
module.exports = function(self, options) {
  ...
  // Add a migration function to be invoked when the geoportal-migrations:migrate task is invoked.
  //
  ...
  self.eachDoc = function(criteria, limit, iterator, callback) {
    ...
    return self.each(self.geop.docs.db, criteria, limit, iterator, callback);
  };
  ...
  // to run the `geoportal-migration:migrate` task.
  //
  ...
  self.addSortify = function(migrationNamePrefix, criteria, field) {
    self.add(migrationNamePrefix + ':' + field + '-sortified', function(callback) {
      ...
      return self.eachDoc({
        ...
        var $set = {};
        $set[field + 'Sortified'] = self.geop.utils.sortify(doc[field]);
