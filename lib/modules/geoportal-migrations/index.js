// Provide services for database migration. The `geoportal-migrations:migrate` task
...
// errors.
//
// Migrations MUST be idempotent (it must be safe to run them twice). Geoportal
...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.on('geoportal:migrate', 'runRegisteredMigrations', function(options) {
