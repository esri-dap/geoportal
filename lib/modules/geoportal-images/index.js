// A subclass of `geoportal-pieces`, `geoportal-images` establishes a library
// of uploaded images in formats suitable for use on the web.
//
// Together with [geoportal-images-widgets](https://docs.geoportalcms.org/geoportal/modules/geoportal-images-widgets),
...
//
// Each `geoportal-image` doc has an `attachment` schema field, implemented
// by the [geoportal-attachments](https://docs.geoportalcms.org/geoportal/modules/geoportal-images-widgets) module.

module.exports = {
  extend: 'geoportal-pieces',
  name: 'geoportal-image',
  slugPrefix: 'image-',
  label: 'Image',
  alias: 'images',
  perPage: 20,
