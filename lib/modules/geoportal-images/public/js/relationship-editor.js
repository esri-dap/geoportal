geop.define('geoportal-images-relationship-editor', {
  ...
  construct: function(self, options) {
    ...
    self.action = geop.docs.getManager(options.field.withType).options.action;
    ...
    self.crop = function() {
      ...
      return geop.attachments.crop(self.image.attachment, options, function(err, crop) {
        if (err) {
