...
geop.define('geoportal-pages', {
  ...
  construct: function(self) {
    self.addLinks = function() {
      geop.ui.link('geop-insert', 'page', function() {
        geop.create('geoportal-pages-editor', { action: self.options.action });
      });
      geop.ui.link('geop-copy', 'page', function() {
        geop.create('geoportal-pages-editor-copy', { action: self.options.action });
      });
      geop.ui.link('geop-update', 'page', function() {
        self.pageSettings();
      });
      geop.ui.link('geop-reorganize', 'page', function() {
        self.reorganize();
      });
      geop.adminBar.link(self.__meta.name, function() {
        self.reorganize();
      });
      geop.ui.link('geop-trash', 'page', function() {
      ...
      geop.ui.link('geop-publish', 'page', function() {
        // fetch the page
