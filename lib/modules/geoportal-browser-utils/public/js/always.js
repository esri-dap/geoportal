geop.define('geoportal-browser-utils', {
  construct: function(self, options) {
    ...
    // KEEP IN SYNC WITH SERVER SIDE VERSION IN geoportal.js
    //
    ...
    // for `geoportal-assets` and the user is not logged in.
    ...
    // Examples:
    //
    // geop.eventName('aposChange', 'blog') ---> aposChangeBlog
    // geop.eventName('aposChangeEvents') ---> aposChangeEvents
    // geop.eventName('geop-jump-gleefully') ---> aposJumpGleefully
    //
    ...
    self.eventName = function() {
      ...
      return geop.camelName(args.join('-'));
    };
    ...
    // an alias for `geop.utils.log`. Note that
    ...
    self.info = function(msg) {
      ...
      geop.utils.log.apply(apos, arguments);
    };
    ...
    self.warn = function(msg) {
      ...
      geop.utils.error.apply(apos, arguments);
    };
