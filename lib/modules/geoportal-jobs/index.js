// The `geoportal-jobs` module runs long-running jobs in response
// to user actions. Batch operations on pieces are a good example.
//
// The `geoportal-jobs` module makes it simple to implement
...
// see the examples already in `geoportal-pieces` and those added
// by the `geoportal-workflow` module. You don't need to go
...
//
// The `geoportal-jobs` module DOES NOT have anything to do with
