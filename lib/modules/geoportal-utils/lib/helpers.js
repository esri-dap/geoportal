...
module.exports = function(self, options) {
  return {
    ...
    // Outputs nothing to the template. Invokes geop.utils.log,
    // which by default invokes console.log.
    log: function(msg) {
      self.log.apply(self.geop, arguments);
      return '';
    },
    ...
    // an array property of the first object, geop.utils.groupByArray is called.
    //
    // Usage: {{ geop.utils.groupBy(people, 'age') }} or {{ geop.utils.groupBy(items, 'tags') }}
    ...
    // those keys. For instance, geop.utils.object('name', 'bob')
