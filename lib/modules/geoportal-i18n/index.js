...
// as `geop.i18n`. Geoportal also makes this available in Nunjucks templates via the
...
module.exports = {
  construct: function(self, options) {
    ...
    _.defaults(i18nOptions, {
      locales: [ 'en' ],
      cookie: self.geop.shortName + '.locale',
      directory: self.options.localesDir || (self.geop.rootDir + '/locales')
    });
    i18n.configure(i18nOptions);

    // Make the i18n instance available globally in Geoportal
    self.geop.i18n = i18n;
  }
};
