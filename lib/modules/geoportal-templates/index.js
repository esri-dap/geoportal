...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.templateApos = {
      modules: {},
      log: function(msg) {
        self.geop.utils.log.apply(self.apos, arguments);
      },
    ...
    // Apostrophe Nunjucks helpers such as `geop.area` are
    ...
    self.renderPageForModule = function(req, template, data, module) {
      ...
      if (req.query.apos_refresh) {
        ...
        req.browserCall('geop.pageReadyWhenCalm($("[data-apos-refreshable]"))');
      } else if (decorate) {
        // Trigger the geop.ready and geop.enhance events after the
        // DOM settles and pushed javascript has had a chance to run
