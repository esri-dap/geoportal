  ...
  init: function(editor) {
    ...
    editor.addCommand('split', new CKEDITOR.command(editor, {
      exec: function(editor) {
        var $area = editor.geopWidgetEditor.$widget.closest('[data-geop-area]');
        var $widget = editor.geopWidgetEditor.$widget;
        ...
        var splitMarker = geop.utils.generateId();
        ...
        function insertTwo(callback) {
          ...
          return setImmediate(function() {
            return areaEditor.addItem($widget, 'geoportal-rich-text', {content: html2}, callback);
          });
        }
        ...
        function insertOne(callback) {
          ...
          // between rich text editors by waiting a tick
          return setImmediate(function() {
            return areaEditor.addItem($widget, 'geoportal-rich-text', {content: html1}, callback);
          });
        }
      }
    }));
