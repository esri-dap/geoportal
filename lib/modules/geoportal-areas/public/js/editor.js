...
geop.define('geoportal-areas-editor', {
  ...
  construct: function(self, options) {
    ...
    self.moveItem = function($el) {
      ...
      geop.emit('widgetMoved', $wrapper.find('[data-apos-widget]'));
    };
    ...
    self.trashItem = function($el) {
      ...
      $undoer.find('[data-apos-widget-type-label]').text(geop.areas.getWidgetManager($widget.attr('data-apos-widget')).label);
    ...
    self.removeInitialContent = function($el, entireItem) {
      if (entireItem) {
        ...
        $el.find('[data-apos-widget="geoportal-rich-text"]:has([data-initial-content])').remove();
      } else {
