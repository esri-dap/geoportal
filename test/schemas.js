...
describe('Schemas', function() {
  ...
  it('should compose schemas correctly', function() {
    ...
    var schema = geop.schemas.compose(options);
  ...
  it('should compose a schema for a complex real world case correctly', function() {
    var schema = geop.schemas.compose(realWorldCase);
    assert(schema);
  ...
  it('should error if a field is required and an empty value is submitted for a string field type', function(done) {
    var schema = geop.schemas.compose({
      addFields: [
        {
          type: 'string',
          name: 'name',
  ...
  it('should convert string areas correctly', function(done) {
    var schema = geop.schemas.compose(hasArea);
    assert(schema.length === 1);
    var input = {
      irrelevant: 'Irrelevant',
    ...
    var req = geop.tasks.getReq();
    var result = {};
    return geop.schemas.convert(req, schema, 'string', input, result, function(err) {
      assert(!err);
      // no irrelevant or missing fields
      assert(_.keys(result).length === 1);
      // expected fields came through
      ...
      assert(result.body.items[0].type === 'geoportal-rich-text');
      assert(result.body.items[0].content === geop.utils.escapeHtml(input.body));
      done();
    });
  });
  ...
  it('should clean up extra slashes in page slugs', function(done) {
    var req = geop.tasks.getReq();
    var schema = geop.schemas.compose({ addFields: pageSlug });
    assert(schema.length === 1);
    var input = {
  ...
  it('does not keep slashes when page: true not present for slug', function(done) {
    var req = geop.tasks.getReq();
    var schema = geop.schemas.compose({ addFields: regularSlug });
    assert(schema.length === 1);
    var input = {
      slug: '/wiggy//wacky///wobbly////whizzle/////'
    };
  ...
  it('enforces required property for ordinary field', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { age: '' }, output, function(err) {
      assert(err);
  ...
  it('ignores required property for hidden field', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { ageOrShoeSize: 'shoeSize', age: '' }, output, function(err) {
      assert(!err);
  ...
  it('enforces required property for shown field', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { ageOrShoeSize: 'age', age: '' }, output, function(err) {
      assert(err);
      assert(err === 'age.required');
      done();
    });
  ...
  it('ignores required property for recursively hidden field', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { ageOrShoeSize: 'age', doWeCare: '0', age: '' }, output, function(err) {
      assert(!err);
  ...
  it('enforces required property for recursively shown field', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { ageOrShoeSize: 'age', doWeCare: '1', age: '' }, output, function(err) {
      assert(err);
      assert(err === 'age.required');
      done();
    });
  ...
  it('enforces required property for recursively shown field with checkboxes', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { ageOrShoeSize: ['age', 'shoeSize'], doWeCare: ['1'], age: '' }, output, function(err) {
      assert(err);
      assert(err === 'age.required');
      done();
    });
  ...
  it('ignores required property for recursively hidden field with boolean', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { ageOrShoeSize: 'age', doWeCare: false, age: '' }, output, function(err) {
      assert(!err);
      assert(output.ageOrShoeSize === 'age');
      done();
    });
  ...
  it('enforces required property for recursively shown field with boolean', function(done) {
    ...
    var output = {};
    geop.schemas.convert(req, schema, 'form', { ageOrShoeSize: ['age', 'shoeSize'], doWeCare: true, age: '' }, output, function(err) {
      assert(err);
      assert(err === 'age.required');
      done();
    });
